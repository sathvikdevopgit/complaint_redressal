...
public class CustomerDto {
	...
	public CustomerDto(User user, Set<String> serviceType, String address, String zipcode) {
		super();
		this.user = user;
		this.serviceType = serviceType;
		this.address = address;
	...
	public String toString() {
		return "CustomerDto [user=" + user + ", serviceType=" + serviceType + ", address=" + address + ", zipcode="
				+ zipcode + "]";
	}
